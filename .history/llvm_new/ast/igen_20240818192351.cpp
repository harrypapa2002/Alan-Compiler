...
llvm::Value *If::igen() const
{
    ...
    // Create the conditional branch to either the 'then' or 'else' block
    ...
    // Add the 'else' block to the function and generate its code
    ...
    // Add the 'mergeBB' block to the function and set it as the current insertion point
